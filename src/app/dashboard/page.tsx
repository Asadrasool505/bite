  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7]">
      <div className="max-w-7xl mx-auto px-6 py-20">
        {/* Page Header */}
        <div className="mb-12 border-b border-slate-200 pb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 bg-white/5 border border-slate-200 rounded-3xl p-8 backdrop-blur-sm relative overflow-hidden flex flex-col">
            ...
            <div className="space-y-4 border-t border-slate-200 pt-6 flex-grow">
              <div>
          ...
          <div className="lg:col-span-2 bg-white/5 border border-slate-200 rounded-3xl p-8 backdrop-blur-sm">
            <h2 className="text-xl font-serif text-white tracking-wide mb-6">
              Wholesale Quote & Ordering History
            </h2>

            {quotes.length === 0 ? (
              <div className="border border-dashed border-slate-200 rounded-2xl p-12 text-center flex flex-col items-center justify-center">
                ...
                <p className="text-xs text-slate-500">Items added to your quote cart will show up here once submitted.</p>
              </div>
            ) : (
              <div className="space-y-6">
                {quotes.map((quote: any, idx: number) => (
                  <div key={idx} className="border border-slate-200 bg-white/50 rounded-2xl p-6 relative overflow-hidden">
                        ...
                        <table className="w-full text-left text-xs text-slate-600">
                          ...
                          <tbody>
                            {quote.items?.map((item: any, iIdx: number) => (
                              <tr key={iIdx} className="border-b border-slate-100 last:border-0">
