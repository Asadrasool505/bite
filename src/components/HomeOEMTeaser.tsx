...
export default function HomeOEMTeaser() {
  ...
  return (
    <section className="w-full py-24 bg-[#050814] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 w-full relative z-10">
        <div className="relative rounded-3xl p-8 md:p-16 bg-gradient-to-br from-white/5 to-[#0A1128]/80 border border-white/10 backdrop-blur-2xl overflow-hidden shadow-[0_30px_70px_rgba(0,0,0,0.7)] group hover:border-yellow-500/35 transition-all duration-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6 md:space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-4xl md:text-6xl font-serif text-white font-extrabold tracking-tight leading-none uppercase">
                  {t("oem_teaser_title")}
                </h2>
              ...
              <div>
                ...
                <Link
                  ...
                  className="btn-pulse-glow inline-flex items-center justify-center px-10 py-5 rounded-2xl font-black uppercase tracking-[0.25em] text-xs text-[#0A1128] bg-gradient-to-r from-yellow-100 via-yellow-400 to-yellow-600 hover:shadow-[0_15px_40px_rgba(250,204,21,0.5)] transition-all cursor-pointer transform hover:-translate-y-0.5"
                >
                  {t("oem_teaser_btn")}
                </Link>
              </div>
            ...
            <div className="lg:col-span-5 relative w-full aspect-square bg-[#050814]/60 border border-white/5 rounded-3xl flex items-center justify-center p-8 overflow-hidden group/graphic">
